...
getStats <- function(func) {
  ...
  early_season_stats <- 
    func(getGames(weeks = 1:9)) |>
    dplyr::mutate('label' = 'Weeks 1-9')
  
  recent_stats <- 
    func(getGames(weeks = 10:18)) |>
    dplyr::mutate('label' = 'Weeks 10-18')
